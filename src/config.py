...
# Volumes
VOL_COLS = {
    "VOL_AB_NM": "Abertura NM",
    "VOL_FE_NM": "Fechamento NM",
    ...
    "VOL_TOA_PRIM_INT": "TOA 1ª Interação",
    "VOL_TOA_FORM": "TOA Formulário",
    "VOL_TELEFONIA_RECEBIDO": "Telefonia Recebido",
    "VOL_TELEFONIA_ATENDIDO": "Telefonia Atendido",
    "VOL_TELEFONIA_REALIZADO": "Telefonia Realizado",
}
